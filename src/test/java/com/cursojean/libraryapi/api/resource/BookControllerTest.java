...
public class BookControllerTest {
    ...
    public void createBookTest() throws Exception{
        ...
        Book savedBookt = createValidBook();

        BDDMockito.given(service.save(Mockito.any(Book.class))).willReturn(savedBookt);
    ...
    public void updateinexistentBookTest() throws Exception{
        ...
        BookDTO dto = createNewBook();
        dto.setTitle("As aventuras alteradas");
    ...
    private Book createValidBook() {
        return Book.builder().author("Arthur")
                .id(10l)
                .title("As aventuras")
                .isbn("001")
                .build();
